...
KITTI_DATASET_DIR='/mnt/tecmint/data/hjl/dataset/KITTI'
OUTPUT_DIR="$SCRIPTDIR/../data/KITTI/"
...
export PATH='/mnt/tecmint/data/hjl/MATLAB/R2018a/bin/'
...
do
	...
	sudo matlab -nodisplay -nodesktop -sd $MATLAB_SCRIPTS_DIR -r "run_OxtsToPoseTxt('$KITTI_DATASET_DIR/$SEQ_DIR'); exit"
done
fi
