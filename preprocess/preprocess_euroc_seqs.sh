...
# 注意：运行指令为 bash ./preprocess_euroc_seqs.sh
...
#EUROC_DATASET_DIR='/home/dell/data/dataset/EuRoC/'
EUROC_DATASET_DIR='/mnt/tecmint/data/hjl/dataset/EuRoC/'
OUTPUT_DIR="$SCRIPTDIR/../data/EuRoC/"
